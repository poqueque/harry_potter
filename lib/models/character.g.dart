...
void _characterSerialize(
  ...
  writer.writeLong(offsets[5], object.strength);
  writer.writeLong(offsets[6], object.totalStars);
...
Character _characterDeserialize(
  ...
  object.id = id;
  object.reviews = reader.readLong(offsets[3]);
  object.totalStars = reader.readLong(offsets[6]);
  return object;
}
